...
def main():
    ...
    parser.add_argument('--strategy', type=str, default="fsdp", metavar='T',
                        help='For Saving the current Model')
    ...
    fabric = Fabric(accelerator="gpu", strategy=args.strategy, devices=2, num_nodes=1)
    fabric.launch()   
    ...
    #Usar esta definicion para fsdp
